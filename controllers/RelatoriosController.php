...
class RelatoriosController {
    ...
    public function entregasGerais(): void {
        Auth::requireAuth(['ADMINISTRADOR', 'TECNICO_SST', 'GESTOR', 'RH_ADMINISTRATIVO', 'ALMOXARIFE_OPERADOR']);
    ...
    public function relatorioGeralEpis(): void {
        $currentUser = Auth::requireAuth(['ADMINISTRADOR', 'TECNICO_SST', 'GESTOR', 'RH_ADMINISTRATIVO', 'ALMOXARIFE_OPERADOR']);
